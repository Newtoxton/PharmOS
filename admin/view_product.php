...
<div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">Retail</th>
                                      <th style="text-align:center;">Wsale</th>
                ...
                $id=$_GET['id'];
                $i = 0;
								$result= mysqli_query($con, "select c.trade_name, c.generic_name,c.sell_price, c.wsell, i.pid, i.batch, i.cost_price, i.quantity, i.qty_sold, date_format(i.datetime, '%d/%m/%y') AS DATE, i.expiry_date FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno  WHERE  invoice_id='$id'  ORDER BY i.pid ASC" ) or die (mysql_error());
                ...
                <td><?php echo ++$i ;  ?> </td>
								...
								<td style="width:150px;"> <?php echo $row ['wsell']; ?></td>
