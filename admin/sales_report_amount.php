        ...
        <div class="box-body">
         <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
<form action="sales_report_amount.php" method="get">
<center><strong>
...
<table class="table table-bordered table-striped" id="table_example" data-responsive="table" >
	...
	<tbody>
		...
		$result = $dbo->prepare("select c.trade_name, c.generic_name,i.cost_price,s.price, SUM(s.quantity) AS quantity,SUM(i.quantity) AS qty, SUM(s.amount) AS amount, d.date
