...
if(isset($_POST['submit'])){
			  ...
			  header('location: edit_receipt.php?id='.$invoice_id);
...
<form method="POST" action="add_stocks.php">
           ...
           <input type="hidden" data-type="generic_name" name="sno" id="itemName_1" class="form-control autocomplete_txt" autocomplete="off">
			...
			<td><input type="text" name="cost_price" id="price_1" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
