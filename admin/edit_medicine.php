        ...
        <div class="box-body">
         <!-- general form elements -->
          <div class="box box-primary">
			...
			<?php
	$id=$_GET['id'];
	$result = $dbo->prepare("select * from medicine_list WHERE sno= :userid");
...
?>
         ...
         <div class="form-group">
           ...
           <input type="text"  name="retail" class="form-control" id="checkleng"  value="<?php echo $row['sell_price']; ?>">
  </div>


  <div class="form-group">
    <label for="exampleInputEmail1">Wholesale Price</label>
    <input type="text"  name="wsell" class="form-control" id="checkleng"  value="<?php echo $row['wsell']; ?>">
</div>
