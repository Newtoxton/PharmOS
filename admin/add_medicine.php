...
<form name='form1' action="add_medicine_store.php" id="invoice-form" method="post" role="form" >
			<div class="row">
				<div class="col-xs-6">
						</br>
						</br>
	      			...
	      			<table class="table table-bordered table-hover" id="invoice_table">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" step="any" name="data[0][sell_price]" id="sellPrice_1" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly ></td>
								<td><input type="text" step="any" name="data[0][wsale_price]" id="wsalePrice_1" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly ></td>
