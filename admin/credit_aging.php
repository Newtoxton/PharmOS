...
Aging Summary for&nbsp;<?php echo $_GET['customer'] ?>
</div>
	...
	<tbody>
			...
			<?php
               ...
               r.aging,
					...
					FROM ( SELECT id, customer, date, time, cash, DATEDIFF(CURRENT_TIMESTAMP, created) AS aging FROM sales_details
					...
					WHERE cash ='No' AND `customer` = '$customer' AND paid IS NULL OR paid < amount AND paid != 0
AND amount - paid != 0
ORDER BY aging DESC");
