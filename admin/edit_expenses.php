...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Expenses
        <small>Edit pharmacy expenses</small>
      </h1>
      <ol class="breadcrumb">
	...
	$id=$_GET['id'];
	$result = $dbo->prepare("SELECT * FROM bills WHERE id= :userid");
...
?>		
           ...
           <form role="form" method="post"  action="updateexpenses.php" >
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Payment Type</label>
				   <input type="text"  name="type"  class="form-control" id="exampleInputEmail1" value="<?php echo $row['source']; ?>">
                   </div>
				 <div class="form-group">
                  <label for="exampleInputEmail1">Description</label>
                   <input type="text"  name="description"  class="form-control" id="exampleInputEmail1" value="<?php echo $row['description']; ?>">
                </div>
				
				
				 <div class="form-group">
                  <label for="exampleInputEmail1">Total Bill</label>
                  <input type="text"  name="total_amount"  class="form-control" id="exampleInputEmail1" value="<?php echo $row['total_amount']; ?>" >
                </div>
				
				
				 <div class="form-group">
                  <label for="exampleInputEmail1">Amount Paid</label>
                  <input type="text"  name="amount"  class="form-control" id="exampleInputEmail1" value="<?php echo $row['amount']; ?>" >
                </div>
