        ...
        <div class="box-body">
         <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
<form action="purchase_report_all.php" method="get">
  <div class="container">
		   </br>
...
Purchases Report from&nbsp;<?php echo $_GET['d1'] ?>&nbsp;to&nbsp;<?php echo $_GET['d2'] ?>&nbsp;for&nbsp;<?php echo $_GET['supplier'] ?>
</div>
...
<table class="table table-bordered table-striped" id="table_example" data-responsive="table" >
	...
	<thead>
		<tr>
			<th colspan="9" style="border-top:1px solid #999999"> Total: </th>
			<th colspan="1" style="border-top:1px solid #999999"> 
			<?php
				
				$results = $dbo->prepare("SELECT SUM(i.cost_price * i.qty_sold) AS tt FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno   INNER JOIN purchases AS p ON p.id = i.invoice_id
