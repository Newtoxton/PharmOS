...
<div class="table-responsive">
                     <form action="pay_multi_edit.php" method="post">	
                ...
                <th style="text-align:left;">No</th>
                  ...
                  <th style="text-align:center;">Pay</th>
						...
						s.paid
					FROM ( SELECT id, created, supplier, invoiceNo, notes, due_date, invoiceDate FROM purchases
					...
					ON p.id = s.t_id ORDER BY p.created DESC"  ) or die (mysql_error());
