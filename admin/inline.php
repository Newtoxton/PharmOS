...
$queryRecords=mysqli_query($con, "select c.trade_name,c.sell_price, c.wsell, i.pid, i.batch, i.cost_price, greatest(0, i.quantity) quantity, i.expiry_date FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno
 WHERE quantity > 0 ORDER BY c.trade_name ASC")or die(mysqli_error());
...
<div class="table-responsive">
	...
	<td class="editable-col" contenteditable="false" col-index='5' oldVal ="<?php echo $res['quantity'];?>"><?php echo $res['quantity'];?></td>
	<td class="editable-col" contenteditable="true" col-index='6' oldVal ="<?php echo $res['expiry_date'];?>"><?php echo $res['expiry_date'];?></td>
					  </tr>
	  <?php endforeach;?>
