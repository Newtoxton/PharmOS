...
<div class="table-responsive">
                        <table class="table table-bordered table-striped" id="example">
							<form method="POST" action="search_sale1.php" class="navbar-search pull-left">
...
<th style="text-align:center;">Phone</th>
                  ...
                  <th style="text-align:center;">Print</th>
                            ...
                            <tbody>
								<?php
								$result= mysqli_query($con, "SELECT l.id, l.customer,l.phone, l.date, l.time, l.entrant,l.notes, SUM(t.amount) total 
								FROM sales_details AS l INNER JOIN
								sales_list AS t ON  l.id = t.invoice WHERE wsale ='No'  GROUP BY invoice ORDER BY id DESC LIMIT 20 " ) or die (mysql_error());
			 ...
			 <td><form  method="post" action="edit_invoices.php<?php echo '?id='.$row['id']; ?>"><input type='submit'  class="btn btn-success addmore" value='Edit'>	</form></td>
