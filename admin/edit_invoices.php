...
while ($students = mysqli_fetch_array($result)) {
    ...
    echo "<input type='hidden' size='40' name='product[$i]' id='itemName_1' class='form-control autocomplete_txt' value='{$students['product']}' />";
	...
	echo "<td><a href='delete_sales.php?id=$tid&quantity=$q&product=$p&invoice=$j' class='btn btn-danger delete'>  Delete </a></td>";
	echo '</tr>';
	++$i;
}
echo '<tr>';
