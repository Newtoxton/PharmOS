...
<a href="salesw.php" class="btn btn-success">Sales History</a>	
</br>
</br>
<div class="box">
 <div class="box-body">
<div class="table-responsive">
                ...
                <td style="width:150px;"> <?php echo $row ['amount']; ?></td>
			          ...
			          <td><form  method="post" action="delete_sale.php?id=<?php echo $row['transaction_id']; ?>&quantity=<?php echo $row['quantity']; ?>&invoice=<?php echo $row['invoice']; ?>&product=<?php echo $row['product']; ?>"><input type='submit' onClick="return confirm('Are you sure you want to Delete?');" class="btn btn-danger delete"  value='Delete'>	</form></td>
