...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<a href="proforma_list.php"><button class="btn btn-success addmore"> Back to Invoices</button></a>
</div>
</br>
</br>
...
<div id="printableArea">
	...
	<div class="row">
    <div class="col-xs-6">
		 <img src="../uploads/<?php echo $logo; ?>" class="img-rounded" width="100px" /> </br></div>
      ...
      <div class="col-xs-5">
      	...
      	<div class='row'>
      		   <div class="col-xs-12">
      			<table class="table table-bordered table-hover find-duplicates">
					...
					$result = $dbo->prepare("select  c.trade_name,c.generic_name,  s.amount, s. price, s.quantity, i.batch, i.expiry_date
											FROM `medicine_list` AS c INNER JOIN `proforma_list` AS s ON c.sno = s.sno
				...
				<tr>
					...
					<?php
					$sdsd=$_GET['invoice'];
					$resultas = $dbo->prepare("select  SUM(s. price * s.quantity)  FROM `medicine_list` AS c INNER JOIN `proforma_list` AS s
					ON c.sno = s.sno WHERE invoice= :a");
