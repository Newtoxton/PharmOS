...
<form action="" method="post">
					...
					WHERE cash ='No' AND id='$id[$i]' ");
						...
						<td><input type="text"  name="supplier[]" class="form-control" id="skills"  value="<?php echo $row['customer']; ?>" readonly> </td>
						<td> <input type="text"  name="total[]" class="form-control" id="skills" value="<?php echo $row['amount']; ?>" readonly></td>
						<td> <input type="text"  name="amount_paid[]" class="form-control" id="skills" value="<?php echo $row['paid']; ?>" readonly></td>
						<td> <input type="text"  name="bal[]" class="form-control" id="skills" value="<?php echo number_format(round($bal, 0), 0);  ?>" readonly></td>
						
						<td><input name="pay[]" type="text"  class='input' value="0" onchange='updateTotal();'></td>
						<td> <select name="hand[]" class="form-control">
