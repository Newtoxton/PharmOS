  ...
  <div class="content-wrapper">
	...
	$result = $dbo->prepare("SELECT * FROM users ");
				...
				$rowcount = $result->rowcount();
						...
						$query = mysqli_query($con, "SELECT sum(s.quantity * s.price) , d.date FROM sales_list AS s  INNER JOIN `sales_details` AS d ON d.id = s.invoice WHERE STR_TO_DATE(`date`, '%d/%m/%Y') = '$today'")or die(mysqli_error());
