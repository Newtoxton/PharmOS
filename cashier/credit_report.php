...
<!-- Content Wrapper. Contains page content -->
 ...
 <a href="credit_payments.php?d1=0&d2=0&customer=0" class="btn btn-success">Receive Payments</a>			
			
<form action="credit_report.php" method="get">
<div class="container">
		   </br>
...
<table class="table table-bordered table-striped" id="table_example" data-responsive="table" >
 ...
 INNER JOIN  sales_details AS l ON l.id = s.invoice
