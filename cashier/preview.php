...
<div class="container">
	...
	<a href="sales.php"><button class="btn btn-success addmore"> Back to Sales</button></a>
...
<div id="printableArea">
	...
	<div style="font:bold 14px 'Aleo'; padding-left: 100px;">Sales Receipt<br></div>
	<div style="font: 12px 'Aleo';padding-left: 20px;"><?php echo $address ?></br><?php echo $address2 ?>
       <div style="font:bold 14px 'Aleo'; padding-left: 50px;">Tel: <?php echo $phone ?></div>
       <div style="font:bold 14px 'Aleo'; padding-left: 50px;">E-mail: <?php echo $email ?></div>
		<div>
	 ...
	 <table border="1" class="find-duplicates">
		...
		<tbody>
				...
				<tr>
					...
					<tr>
					<td colspan="3" style=" text-align:right;">Cash Tendered: &nbsp;<?php echo $currency  ?></strong></td>
					<td colspan="3" style="text-align: center;">
					<?php
					...
					<tr>
					<td colspan="3" style=" text-align:right;">Change: &nbsp;<?php echo $currency  ?></strong></td>
					<td colspan="3" style="text-align: center;">
					<?php
