...
<div class="table-responsive">
	...
	<td class="editable-col" contenteditable="true" col-index='3' oldVal ="<?php echo $res['sell_price'];?>"><?php echo $res['sell_price'];?></td>
	<td class="editable-col" contenteditable="true" col-index='4' oldVal ="<?php echo $res['wsell'];?>"><?php echo $res['wsell'];?></td>
	<td class="editable-col" contenteditable="true" col-index='5' oldVal ="<?php echo $res['wsell2'];?>"><?php echo $res['wsell2'];?></td>
