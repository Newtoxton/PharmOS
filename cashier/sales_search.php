...
<div class="table-responsive">
						...
						<form method="POST" action="search_sales.php" class="navbar-search pull-left">
                  ...
                  <th style="text-align:center;">Print</th>
                            ...
                            <tbody>
								...
								sales_list AS t ON  l.id = t.invoice GROUP BY invoice ORDER BY id DESC LIMIT 15" ) or die (mysql_error());
