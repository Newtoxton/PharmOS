...
<!-- Content Wrapper. Contains page content -->
         ...
         <!-- general form elements -->
          <div class="box box-primary">
			...
			<?php
				...
				mysqli_query($con, "insert into supplier (name,address,phone,contact_person, notes) values('$name','$address','$phone','$contact_person','$notes')")or die(mysqli_error());
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
					...
					<tbody>
						...
						$query=mysqli_query($con, "SELECT *  FROM `supplier` ORDER BY name ASC ")or die(mysqli_error());
						...
						<td><a href="edit_supplier.php?id=<?php echo $row['id']; ?>"><input type='submit' class="btn btn-success addmore" value='Edit'>	</a></td>
						<td><a href="delete_supplier.php?id=<?php echo $row['id']; ?>"><input type='submit'  type='submit' onClick="return confirm('Are you sure you want to Delete?');" class="btn btn-danger delete" value='Delete'>	<a/></td>
 ...
 <div class="box-header with-border">
           ...
           <form role="form" method="post" name='form1'  action="supplier.php" >
              <div class="box-body">
				...
				<label for="exampleInputEmail1">Contact Person</label>
                  <input type="text"  name="contact_person" class="form-control" id="skills" placeholder="Enter Person" required>
                </div>
