...
while ($students = mysqli_fetch_array($result)) {
	...
	echo "<input type='hidden' size='40' name='sno[$i]' id='itemName_1' class='form-control autocomplete_txt' value='{$students['sno']}' readonly />";
    echo "<td><input type='text' size='40' name='price[$i]' id='price_$tid' class='form-control changesNo' value='{$students['price']}' readonly /></td>";
	echo "<input type='hidden' size='40' name='qty1[$i]'  value='{$students['quantity']}' />";
	echo "<td><input type='text' size='40' name='quantity[$i]' id='quantity_$tid' class='form-control changesNo' value='{$students['quantity']}' readonly /></td>";
	echo "<td><input type='text' size='40' name='amount[$i]' id='total_$tid' class='form-control totalLinePrice' value='{$students['amount']}' readonly /></td>";
