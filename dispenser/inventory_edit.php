 ...
 <form method="POST" action="inventory_search.php" class="navbar-search pull-left">
                        ...
                        <table class="table table-bordered table-striped" id="example">
                            ...
                            <tbody>
								...
								$result= mysqli_query($con, "select c.trade_name, c.generic_name,c.sell_price, c.wsell, i.pid, i.batch, i.quantity, i.cost_price, i.qty_sold, date_format(i.datetime, '%d/%m/%y') AS DATE, i.expiry_date FROM `medicine_list` AS c INNER JOIN `inventory` AS i ON c.sno = i.sno   ORDER BY i.pid Desc LIMIT 15" ) or die (mysql_error());
