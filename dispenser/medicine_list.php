...
<div ng-controller="customersCrtl">
    ...
    <div class="row">
        <div class="col-md-12" ng-show="filteredItems > 0">
            ...
            <th>Medicine Type&nbsp;<a ng-click="sort_by('generic_name');"><i class="glyphicon glyphicon-sort"></i></a></th>
            <th>Retail&nbsp;<a ng-click="sort_by('generic_name');"><i class="glyphicon glyphicon-sort"></i></a></th>
            <th>Wholesale&nbsp;<a ng-click="sort_by('generic_name');"><i class="glyphicon glyphicon-sort"></i></a></th>
            </thead>
            <tbody>
