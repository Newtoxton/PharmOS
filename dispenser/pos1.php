		  ...
		  <div class="box">
            <div class="box-header">
							<h3 class="box-title">Quick Search</h3>
									...
									?>
									<option value="<?php echo $row['id'];?>"> <?php echo $row['trade_name']; ?>  | <?php echo $row['generic_name']; ?> | Cost @ <?php echo $row['cost_price']; ?> | Price @ <?php echo $row['sell_price']; ?> | Expires on: <?php echo $row['expiry_date']; ?> | Qty Left: <?php echo $row['quantity']; ?></option>
									<?php
									 }
									?>
									</select>
...
<form name='form1' action="<?php echo $_SERVER['PHP_SELF']; ?>" id="invoice-form" method="post" role="form" novalidate>
			<div class="row">
				<div class="col-xs-6">
					...
					<select name="customer"  class="chzn-select" style="width:350px; height:15px" >
				...
				<table class="find-duplicates table table-bordered table-striped"  id="invoice_table">
	      			
					
					<thead>
							<tr>
								<th width="4%"> <input id="check_all" class="formcontrol" type="checkbox"/></th>
								 <th width="15%" class="duplifer-highlightdups">Brand Name</th>
