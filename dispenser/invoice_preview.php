...
$result = $dbo->prepare("SELECT * FROM invoices WHERE invoice= :userid ORDER BY transaction_id DESC");
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<a href="invoice_view.php"><button class="btn btn-success addmore"> Back to Invoices</button></a>
</div>
</br>
</br>
