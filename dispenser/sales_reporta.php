...
FROM `medicine_list` AS c INNER JOIN `sales_list` AS s ON c.sno = s.sno INNER JOIN `sales_details` AS d ON d.id = s.invoice WHERE STR_TO_DATE(`date`, '%m/%d/%Y') BETWEEN '" . $start_date . "' AND '" . $end_date . "' ORDER by transaction_id DESC");
